...
namespace task_4._3
{
    class arrClass
    {
        ...
        public arrClass(string fileName)
        {
            try
            {
        ...
        public arrClass(int n, int start, int step)
        {
            a = new int[n];
            for (int i = 0; i < n; i++)
            {
        ...
        /// </summary>
        /// <param name="arr"></param>
        public static arrClass Inverse(arrClass arr)
        {
            arrClass newArr = new arrClass(arr);            
            return newArr;
        }
